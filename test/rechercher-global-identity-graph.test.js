...
describe('Rechercher global identity/graph/reproducibility', () => {
  it('resolves identities and deduplicates manifestations without losing canonical identity', () => {
  ...
  it('keeps AI claims non-publishable and requires scholar-reviewed evidence plus allowed rights', () => {
  ...
  it('records reproducible source and transformation lineage', () => {
