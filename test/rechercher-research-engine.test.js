...
test('unresolved uncertainty blocks publication',()=>{const e=createResearch();openCase(e,{id:'r2',question:'Compare views'});attachEvidence(e,{caseId:'r2',sourceId:'s1',claimId:'c1'});advanceCase(e,'r2','SYNTHESIS');advanceCase(e,'r2','VERIFICATION');addUncertainty(e,'r2','edition unresolved');assert.throws(()=>advanceCase(e,'r2','PUBLISHED'));});
