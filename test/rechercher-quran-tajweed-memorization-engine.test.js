...
test('preserves canonical Arabic registration by source hash', () => {
...
test('keeps automated tajweed findings provisional until human review', () => {
  const e = createQuranTajweedMemorizationEngine();
...
test('tracks memorization independently from canonical source text', () => {
  const e = createQuranTajweedMemorizationEngine();
  registerVerse(e,{verseId:'1:1',surah:1,ayah:1,arabic:'نَصّ',sourceId:'q',sourceHash:'h'});
