...
const aliases = {
  "sermons-lessons": ["محاضرة", "درس", "خطبة", "خطبة الجمعة", "خطبة العيد", "الزواج", "عقد القران", "رمضان", "موعظة", "جنازة", "صلاة الميت"],
  ...
  "fiqh-transactions": ["الربا", "فائدة القرض", "فوائد القرض", "فوائد البنك", "بيع الذهب بالذهب", "الذهب بالفضة", "الصرف", "ربا الديون", "ربا الفضل", "ربا النسيئة", "الغرر", "بيع الغرر", "أكل أموال الناس", "مال اليتيم", "أكل مال اليتيم", "الغش", "النجش", "الاحتكار", "القمار", "الميسر", "البيع المحرم", "المعاملات", "بيع ما ليس عندي", "بيع ما ليس عندك"],
...
const priorityRules = [
  { engineId: "fiqh-transactions", patterns: [["بيع", "الذهب"], ["ذهب", "ذهب"], ["ذهب", "فضة"], ["الربا"], ["فائدة", "القرض"], ["فوائد", "القرض"], ["فوائد", "البنك"], ["ربا", "الديون"], ["الغرر"], ["مال", "اليتيم"], ["أكل", "أموال", "الناس"], ["الغش"], ["النجش"], ["الاحتكار"], ["القمار"], ["الميسر"], ["البيع", "المحرم"], ["المعاملات"]]},
  { engineId: "worship-teaching", patterns: [["صلاة", "الجنازة"], ["صلاة", "الميت"], ["كيف", "اصلي", "الجنازة"], ["كيف", "اصلي", "الميت"], ["صفة", "صلاة", "النبي"], ["سجود", "السهو"], ["سجود", "التلاوة"], ["كيف", "اتوضأ"], ["كيف", "اصلي"], ["زكاة", "الفطر"], ["صلاة", "الكسوف"], ["صلاة", "الخسوف"], ["صلاة", "الاستخارة"], ["صلاة", "الخوف"], ["صلاة", "المسافر"], ["صلاة", "الجمعة"], ["صلاة", "العيد"]]},
...
function detectDeterministicIntent(q) {
  if (hasAny(q, ["بيع ما ليس عندي", "بيع ما ليس عندك", "الربا", "فائدة القرض", "فوائد القرض", "فوائد البنك", "بيع الذهب بالذهب", "الذهب بالفضة", "الصرف", "ربا الديون", "ربا الفضل", "ربا النسيئة", "الغرر", "بيع الغرر", "مال اليتيم", "أكل مال اليتيم", "أكل أموال الناس", "الغش", "النجش", "الاحتكار", "القمار", "الميسر", "البيع المحرم", "المعاملات"])) return "fiqh-transactions";
