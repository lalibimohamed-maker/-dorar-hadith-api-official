...
const aliases = {
  ...
  "fiqh-transactions": ["الربا", "فائدة القرض", "فوائد البنك", "بيع الذهب بالذهب", "الذهب بالفضة", "الصرف", "ربا الديون", "ربا الفضل", "ربا النسيئة", "الغرر", "بيع الغرر", "أكل أموال الناس", "مال اليتيم", "أكل مال اليتيم", "الغش", "النجش", "الاحتكار", "القمار", "الميسر", "البيع المحرم", "المعاملات", "بيع ما ليس عندي", "بيع ما ليس عندك"],
...
const priorityRules = [
  { engineId: "fiqh-transactions", patterns: [["بيع", "الذهب"], ["ذهب", "ذهب"], ["ذهب", "فضة"], ["الربا"], ["فائدة", "القرض"], ["فوائد", "البنك"], ["ربا", "الديون"], ["الغرر"], ["مال", "اليتيم"], ["أكل", "أموال", "الناس"], ["الغش"], ["النجش"], ["الاحتكار"], ["القمار"], ["الميسر"], ["البيع", "المحرم"], ["المعاملات"]]},
...
function detectDeterministicIntent(q) {
  if (hasAny(q, ["بيع ما ليس عندي", "بيع ما ليس عندك", "الربا", "فائدة القرض", "فوائد البنك", "بيع الذهب بالذهب", "الذهب بالفضة", "الصرف", "ربا الديون", "ربا الفضل", "ربا النسيئة", "الغرر", "بيع الغرر", "مال اليتيم", "أكل مال اليتيم", "أكل أموال الناس", "الغش", "النجش", "الاحتكار", "القمار", "الميسر", "البيع المحرم", "المعاملات"])) return "fiqh-transactions";
