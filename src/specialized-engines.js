...
const priorityRules = [
  { engineId: "fiqh-transactions", patterns: [["بيع", "الذهب"], ["ذهب", "ذهب"], ["ذهب", "فضة"], ["الربا"], ["فائدة", "القرض"], ["فوائد", "البنك"], ["ربا", "الديون"], ["الغرر"], ["مال", "اليتيم"], ["أكل", "أموال", "الناس"], ["الغش"], ["النجش"], ["القمار"], ["الميسر"], ["بيع", "ما", "ليس", "عندي"], ["بيع", "ما", "ليس", "عندك"]]},
...
function detectDeterministicIntent(q) {
  if (hasAny(q, ["الربا", "فائدة القرض", "فوائد البنك", "بيع الذهب بالذهب", "ربا الديون", "الغرر", "مال اليتيم", "أكل أموال الناس", "القمار", "الميسر", "بيع ما ليس عندي", "بيع ما ليس عندك"])) return "fiqh-transactions";
