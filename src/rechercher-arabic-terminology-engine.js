export const DIALECTS = Object.freeze(['ARABIC_CLASSICAL', 'ARABIC_MODERN', 'USER_LANGUAGE']);

export function createArabicTerminologyEngine() {
  return { terms: new Map(), concepts: new Map(), alignments: new Map() };
}

export function registerConcept(engine, { conceptId, label, domain, sourceId }) {
...
export function registerTerm(engine, { termId, conceptId, text, language = 'ar', register = 'ARABIC_CLASSICAL', sourceId }) {
...
export function alignTerms(engine, { alignmentId, termIds, confidence, reviewerId = null }) {
...
export function getConceptTerms(engine, conceptId) {
