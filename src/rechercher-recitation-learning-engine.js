export const RECITATION_STATES = Object.freeze([
  'REGISTERED',
  'ALIGNED',
  'CANDIDATE_ERROR',
  'REVIEW_REQUIRED',
...
export function createRecitationLearningEngine() {
  return { verses: new Map(), recordings: new Map(), alignments: new Map(), reviews: new Map() };
}

export function registerVerse(engine, { verseId, arabic, sourceId, sourceHash }) {
...
export function registerRecording(engine, { recordingId, verseId, reciterId, audioSourceId }) {
...
export function alignRecording(engine, { recordingId, startMs, endMs, reviewerId = null }) {
...
export function recordCandidateError(engine, { recordingId, kind, evidence }) {
...
export function verifyCandidate(engine, { recordingId, kind, reviewerId, decision, note }) {
