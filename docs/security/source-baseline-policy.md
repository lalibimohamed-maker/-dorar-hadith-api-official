...
A baseline may record identifiers, approved host metadata, timestamps, byte counts, hashes, and narrowly scoped verification metadata. It must not contain copied source text, documents, HTML, PDFs, or other authoritative Corpus material.
