...
export default [
  ...
  source({
    ...
    api: {
      baseUrl: 'https://api2.islamhouse.com/v1', documented: true, multilingual: true,
      endpoints: ['/quran/get-available-languages/json', '/quran/get-category/{id}/{language}/json'],
