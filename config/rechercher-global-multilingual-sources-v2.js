...
export default [
  ...
  source({
    ...
    api: { documented: true, multilingual: true, availableLanguagesEndpoint: '/quran/get-available-languages/json', quranCategories: '/quran/get-category/{id}/{language}/json' },
  ...
  source({
    ...
    api: { documented: true, multilingual: true },
  ...
  source({
    ...
    domains: ['islamic-content.com'],
    languages: 'multilingual',
    content: ['books', 'articles', 'quran', 'hadith', 'fatwas', 'media'],
    access: { mode: 'web-discovery' },
    api: null,
    rights: { discovery: true, verifyBeforeAcquisition: true },
  }),
  source({
    id: 'islamqa-multilingual',
    name: 'IslamQA multilingual',
    domains: ['islamqa.info'],
    languages: ['ar', 'en', 'fr', 'ru', 'tr', 'ur', 'id', 'es', 'de', 'bn'],
    content: ['fatwas', 'quran', 'hadith', 'aqidah', 'fiqh'],
    access: { mode: 'web-discovery' },
    api: null,
    rights: { discovery: true, verifyBeforeAcquisition: true },
  }),
