...
module.exports = [
  ...
  source({
    ...
    domains: ['alukah.net'],
    languages: ['ar'],
    content: ['books', 'articles', 'quran', 'hadith', 'fiqh', 'aqidah', 'history'],
    access: { mode: 'web-discovery' },
    rights: { discovery: true, verifyBeforeAcquisition: true },
  }),
  source({
  ...
  source({
    ...
    domains: ['islam.plus'],
    languages: ['ru', 'ar', 'en'],
    content: ['quran', 'hadith', 'articles', 'fatwas'],
    access: { mode: 'web-discovery' },
    rights: { discovery: true, verifyBeforeAcquisition: true },
  }),
  source({
    ...
    domains: ['islamdag.ru'],
    languages: ['ru'],
    content: ['quran', 'hadith', 'fiqh', 'articles', 'audio'],
    access: { mode: 'web-discovery' },
    rights: { discovery: true, verifyBeforeAcquisition: true },
  }),
  source({
    ...
    domains: ['azbyka.ru'],
    languages: ['ru'],
    content: ['comparative-religion', 'islam-reference'],
    access: { mode: 'web-discovery' },
    rights: { discovery: true, verifyBeforeAcquisition: true },
  }),
  source({
  ...
  source({
    id: 'islamicbulletin',
    name: 'Islamic Bulletin',
    domains: ['islamicbulletin.org'],
    languages: ['en', 'es'],
    content: ['quran', 'hadith', 'books', 'articles', 'education'],
    access: { mode: 'web-discovery' },
    rights: { discovery: true, verifyBeforeAcquisition: true },
  }),
  source({
    id: 'whyislam',
    name: 'WhyIslam',
    domains: ['whyislam.org'],
    languages: ['en', 'es'],
    content: ['quran', 'articles', 'books', 'education'],
    access: { mode: 'web-discovery' },
    rights: { discovery: true, verifyBeforeAcquisition: true },
  }),
  source({
  ...
  source({
    ...
    domains: ['islamreligion.com'],
    languages: 'multilingual',
    content: ['articles', 'quran', 'hadith', 'history'],
    access: { mode: 'web-discovery' },
    rights: { discovery: true, verifyBeforeAcquisition: true },
  }),
  source({
    ...
    domains: ['byenah.com'],
    languages: 'multilingual',
    content: ['quran', 'hadith', 'articles', 'education'],
    access: { mode: 'web-discovery' },
    rights: { discovery: true, verifyBeforeAcquisition: true },
  }),
  source({
    ...
    domains: ['daura.com'],
    languages: 'multilingual',
    content: ['courses', 'lectures', 'books', 'articles'],
    access: { mode: 'web-discovery' },
    rights: { discovery: true, verifyBeforeAcquisition: true },
  }),
];
