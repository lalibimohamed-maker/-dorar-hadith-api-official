...
export const NATIVE_SOURCES = Object.freeze([
  ...
  { id: 'terminology-enc', name: 'Encyclopedia of Translated Islamic Terms', enabled: true, acquisition: 'multilingual-reference-and-web-discovery', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://terminologyenc.com/fr/home', queryMap: q, mapResults: () => [] }, notes: 'Multilingual Islamic terminology reference; supports translated terms across many world languages. Native/API and bulk-download terms remain unverified.' },
  { id: 'alquran-islam-gov-qa', name: 'Qatar Quran Encyclopedia', enabled: true, acquisition: 'quran-reference-and-web-discovery', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://alquran.islam.gov.qa/', queryMap: q, mapResults: () => [] }, notes: 'Qatar Ministry Islamic Affairs Quran resource. Kept as discovery/reference until a documented native interface and redistribution terms are verified.' },
  { id: 'islamic-content-jamharah', name: 'Al-Jamhara / Islamic Content Encyclopedia', enabled: true, acquisition: 'multilingual-reference-and-web-discovery', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://islamic-content.com/', queryMap: q, mapResults: () => [] }, notes: 'Broad multilingual Islamic content platform covering Quran translations, Sunnah translations, narrators, people, places and terminology.' },
  { id: 'islamhouse', name: 'IslamHouse', enabled: true, acquisition: 'multilingual-books-and-pdf-when-permitted', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://islamhouse.com/', queryMap: q, mapResults: () => [] }, notes: 'Large multilingual Islamic books/content portal. PDF availability does not itself grant redistribution rights.' },
  { id: 'islamhouse-d1-assets', name: 'IslamHouse D1 PDF/assets host', enabled: true, acquisition: 'asset-discovery-only', rightsPolicy: 'inherits-parent-source-rights', connector: { kind: 'web-discovery', searchUrl: 'https://d1.islamhouse.com/', queryMap: q, mapResults: () => [] }, notes: 'Asset host retained separately so acquisition can trace the original IslamHouse item and apply its rights policy; never treated as an independent rights grant.' },
  { id: 'islamqa', name: 'Islam Question & Answer', enabled: true, acquisition: 'multilingual-web-reference', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://islamqa.info/ar', queryMap: q, mapResults: () => [] }, notes: 'Multilingual Q&A/reference source. Search and provenance only unless explicit reuse terms are verified.' },
  { id: 'islamreligion', name: 'The Religion of Islam', enabled: true, acquisition: 'multilingual-web-reference', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://www.islamreligion.com/', queryMap: q, mapResults: () => [] } },
  { id: 'byenah', name: 'Bayyinah / Byenah', enabled: true, acquisition: 'multilingual-web-reference', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://byenah.com/', queryMap: q, mapResults: () => [] } },
  { id: 'muslim-library', name: 'Comprehensive Muslim e-Library', enabled: true, acquisition: 'multilingual-pdf-library-when-permitted', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://www.muslim-library.com/', queryMap: q, mapResults: () => [] }, notes: 'Large multilingual PDF library; acquisition remains rights-gated.' },
  { id: 'islamic-bulletin', name: 'Islamic Bulletin', enabled: true, acquisition: 'multilingual-web-and-document-discovery', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://islamicbulletin.org/', queryMap: q, mapResults: () => [] } },
  { id: 'whyislam', name: 'WhyIslam', enabled: true, acquisition: 'multilingual-web-reference', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://www.whyislam.org/', queryMap: q, mapResults: () => [] } },
  { id: 'osoulstore', name: 'Osoul Store', enabled: true, acquisition: 'multilingual-books-pdf-and-digital-when-permitted', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://osoulstore.com/', queryMap: q, mapResults: () => [] }, notes: 'Multilingual Islamic dawah book platform with PDF, audio and interactive formats; rights remain source-controlled.' },
  { id: 'alukah', name: 'Alukah', enabled: true, acquisition: 'multilingual-web-reference-and-book-discovery', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://www.alukah.net/', queryMap: q, mapResults: () => [] } },
  { id: 'ketabonline', name: 'Ketab Online', enabled: true, acquisition: 'book-discovery-and-web-reference', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://ketabonline.com/ar', queryMap: q, mapResults: () => [] } },
  { id: 'azbyka', name: 'Azbyka', enabled: true, acquisition: 'multilingual-web-reference', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://azbyka.ru/', queryMap: q, mapResults: () => [] }, notes: 'Russian-language religious reference retained for broad web discovery; not classified as an Islamic authority source.' },
  { id: 'islam-plus-ru', name: 'Islam.plus Russian', enabled: true, acquisition: 'multilingual-web-reference', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://islam.plus/ru', queryMap: q, mapResults: () => [] } },
  { id: 'islamdag-ru', name: 'IslamDag Russian', enabled: true, acquisition: 'multilingual-web-reference', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://islamdag.ru/', queryMap: q, mapResults: () => [] } },
  { id: 'daura', name: 'Daura', enabled: true, acquisition: 'multilingual-web-reference', rightsPolicy: 'publisher-declared', connector: { kind: 'web-discovery', searchUrl: 'https://daura.com/', queryMap: q, mapResults: () => [] } },
